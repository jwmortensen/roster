...
#   summarise(weight = n()) %>%
#   select(points_in_possession, weight, is_home, matches("*_player_*"))
#
...
#   y = pbp_df_weighted$points_in_possession
# )
#
# save(standat,
#      all_levels,
#      offense_levels,
#      rasch_rapm_df,
#      file = "./data/nba_rapm_input_points_in_possession.RData")

load("./data/nba_rapm_input_points_in_possession.RData")
options(mc.cores = 1)
...
save(stanout, file = "./data/nba_rapm_raw_output_points_in_possession.RData")
...
save(stanout, full_rpm, runtime, file = "./data/apm_model_results_points_in_possession.RData")
